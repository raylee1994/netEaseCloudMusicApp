...
import {createAjax, transformTime, transformDuration} from "common/js/utils";
...
class TopList extends Component {
    ...
    getPlaylist() {
        createAjax(http.get(apisPaths["top/list"], {id: this.state.trackId}), res => {
            this.setState({
                playlist: res.data.playlist.playlist
            })
        })
    }
    componentDidMount() {
                                        ...
                                        this.state.playlist.tracks.map((item, index) => {
                                            return (
                                                <tr key={item.id}>
                                                    ...
                                                    <td>
                                                        <span>{transformDuration(item.dt).min}:{transformDuration(item.dt).sec}</span>
                                                        <div>
